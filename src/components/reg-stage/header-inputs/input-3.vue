<template>
    <div class="searchBox" id="drop_input_3">
        <input type="text" placeholder="Search" class="resize-s">
        <button class="btn" @click="OPEN_RIGHT_PANEL('button')" :style="right_panel.button">Search</button>
    </div>
</template>
