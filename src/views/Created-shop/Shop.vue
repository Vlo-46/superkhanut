...
<script>
    ...
    import categories from '../../components/Created-shop-components/Categories';
    import price_filter from '../../components/Created-shop-components/Filter-by-price';
    import tag_filter from '../../components/Created-shop-components/Filter-by-tag';
    import shop_img from '../../components/Created-shop-components/Shop-image';
    ...
    export default {
        ...
        computed: {
            ...mapState(['footer_info', 'shop_page_filters_ids', 'shop_page_rightBox_ids', 'shop_page_info', 'company_products', 'company_admin_settings']),
